...
--
-- Table structure for table `cmp_aa`
--

DROP TABLE IF EXISTS `cmp_aa`;
...
--
-- Table structure for table `ds_mlat`
--

DROP TABLE IF EXISTS `ds_mlat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `ds_radar`
--

DROP TABLE IF EXISTS `ds_radar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `ds_tracker`
--

DROP TABLE IF EXISTS `ds_tracker`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `le_ds`
--

DROP TABLE IF EXISTS `le_ds`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `le_ds` (
  `DS_ID` smallint(5) unsigned DEFAULT NULL AUTO_INCREMENT COMMENT ' ',
...
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=latin1 COMMENT=' ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sd_mlat`
--

DROP TABLE IF EXISTS `sd_mlat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `sd_radar`
--

DROP TABLE IF EXISTS `sd_radar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sd_radar` (
  ...
  `POS_AZM_DEG` double DEFAULT NULL COMMENT 'Measured position in polar coordinates: Theta in Â¿Â¿ [I001/040, I048/040]',
  ...
  `PSR_RUNLENGTH_DEG` smallint(6) DEFAULT NULL COMMENT 'Primary plot runlength in Â¿Â¿ [048/130 #4 PRL]',
  ...
  `TRACK_HEADING_DEG` double DEFAULT NULL COMMENT 'Calculated track velocity expressed in polar coordinates, angle in Â¿Â¿ [I001/200, I021/160, I048/200]',
...
--
-- Table structure for table `sd_track`
--

DROP TABLE IF EXISTS `sd_track`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
