...
{
    loginf << "importDataSourcesJSONDeprecated";
...
{
    loginf << "deleteAllConfigDataSources";
...
{
    loginf << "setLoadAllDataSourceLines";
...
{
    loginf << "configurationDialogDoneSlot";
