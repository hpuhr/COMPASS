...
{
    logdbg << "disableConfigurationSaving";
...
{
    loginf << "importAsterixRecordingSlot";
...
{
    loginf << "importRecentAsterixRecordingSlot";
...
{
    loginf << "importAsterixFromPCAPSlot";
...
{
    loginf << "importAsterixFromJSONSlot";
...
{
    loginf << "importAsterixFromNetworkSlot";
...
{
    loginf << "calculateRadarPlotPositionsSlot";
...
{
    loginf << "calculateAssociationsARTASSlot";
...
{
    loginf << "reconstructReferencesSlot";
...
{
    loginf << "configureDataSourcesSlot";
...
{
    loginf << "configureMetaVariablesSlot";
...
//{
//    logdbg << "keyPressEvent '" << event->text().toStdString() << "'";
//}
