...
/*
 * DBSchemaEditWidget.h
 *
 *  Created on: Aug 20, 2012
 *      Author: sk
 */

#ifndef DBSCHEMAEDITWIDGET_H_
#define DBSCHEMAEDITWIDGET_H_
...
/**
 * @brief Edit widget for a DBSchema
 */
class DBSchemaEditWidget: public QWidget
{
    Q_OBJECT
...
public:
    /// @brief Constructor
    DBSchemaEditWidget(DBSchema *schema, QWidget * parent = 0, Qt::WindowFlags f = 0);
    /// @brief Destructor
    virtual ~DBSchemaEditWidget();
