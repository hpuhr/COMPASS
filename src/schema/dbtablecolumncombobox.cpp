...
DBTableColumnComboBox::DBTableColumnComboBox(const std::string& schema, const std::string& meta_table,
                                             DBOVariable& variable, QWidget* parent)
    : schema_ (schema), meta_table_ (meta_table), variable_(variable)
{
    ...
    logdbg << "DBTableColumnComboBox: DBTableColumnComboBox: schema " << schema << " varname '" << variable_name << "'";
