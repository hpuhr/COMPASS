...
{
  public:
    StructureDescriptionMLAT()
        : StructureDescription(DBO_MLAT, "MLAT", "RDL communications_capability structure", 0)
    {
        create();
    }
  ...
  protected:
    void create()
    {
        StructureDescription* rdl_description =
            new StructureDescription(DBO_MLAT, "", "rdl communications_capability structure", 0);
        ...
        StructureDescription* communications_capability = rdl_description->addStructureDescription(
            "communications_capability", "Communications/ACAS capability", offset);
        communications_capability->addPresentStructureVariable(
            "present", SE_TYPE_BOOL, 1, "Communications/ACAS capability present",
            offset + offsetof(t_Communications_Capability, present));
        communications_capability->addStructureVariable(
            "value_com", SE_TYPE_USMALLINT, 1, "Communications/ACAS capability",
            offset + offsetof(t_Communications_Capability, value_com));
        //  t_Computed_Position computed_position;
        //                   /* Computed Cartesian position */
        offset = offsetof(t_Mlat, computed_position);
        StructureDescription* computed_position = rdl_description->addStructureDescription(
        ...
        StructureDescription* computed_position_stdev = rdl_description->addStructureDescription(
            "computed_position_stdev", "Standard deviation of computed position", offset);
        computed_position_stdev->addPresentStructureVariable(
            "present", SE_TYPE_BOOL, 1, "Accuracy of computed Cartesian position present",
            offset + offsetof(t_Computed_Position_Accuracy, present));
        computed_position_stdev->addStructureVariable(
            "value_x", SE_TYPE_DOUBLE, 1, "Standard deviation of x component; metres",
            offset + offsetof(t_Computed_Position_Accuracy, value_x));
        computed_position_stdev->addStructureVariable(
            "value_xy", SE_TYPE_DOUBLE, 1, "Correlation coefficient",
            offset + offsetof(t_Computed_Position_Accuracy, value_xy));
        computed_position_stdev->addStructureVariable(
            "value_y", SE_TYPE_DOUBLE, 1, "Standard deviation of y component; metres",
            offset + offsetof(t_Computed_Position_Accuracy, value_y));

        //  t_Computed_Velocity computed_velocity;
        //                   /* Computed Cartesian velocity */
        offset = offsetof(t_Mlat, computed_velocity);
        StructureDescription* calc_vel = rdl_description->addStructureDescription(
            "computed_velocity", "Calculated Cartesian velocity", offset);
        ...
        StructureDescription* flight_status =
            rdl_description->addStructureDescription("flight_status", "Flight status", offset);
        flight_status->addPresentStructureVariable("present", SE_TYPE_BOOL, 1,
                                                   "Flight status present",
                                                   offset + offsetof(t_Flight_Status, present));
        flight_status->addStructureVariable("value_aic", SE_TYPE_UTINYINT, 1,
                                            "Aircraft identification capability",
                                            offset + offsetof(t_Flight_Status, value_aic));
        flight_status->addStructureVariable("value_arc", SE_TYPE_UTINYINT, 1,
                                            "Altitude reporting capability",
                                            offset + offsetof(t_Flight_Status, value_arc));
        flight_status->addStructureVariable("value_b1a", SE_TYPE_UTINYINT, 1, "BDS 1,0 bit 16",
                                            offset + offsetof(t_Flight_Status, value_b1a));
        flight_status->addStructureVariable("value_b1b", SE_TYPE_UTINYINT, 1,
                                            "BDS 1,0 bits 37 to 40",
                                            offset + offsetof(t_Flight_Status, value_b1b));
        flight_status->addStructureVariable("value_mssc", SE_TYPE_UTINYINT, 1,
                                            "Mode S specific service capability",
                                            offset + offsetof(t_Flight_Status, value_mssc));
        flight_status->addStructureVariable("value_status", SE_TYPE_UTINYINT, 1, "Flight status",
                                            offset + offsetof(t_Flight_Status, value_status));
        ...
        rdl_description->addStructureVariable("ground_bit_set", SE_TYPE_BOOL, 1,
                                              "Transponder ground bit set",
                                              offsetof(t_Mlat, ground_bit_set));
        ...
        StructureDescription* mode_c_info = rdl_description->addStructureDescription(
            "mode_c_info", "SSR mode C information", offset);
        mode_c_info->addStructureVariable("code", SE_TYPE_USMALLINT, 1,
                                          "SSR mode C code (as sent down by the transponder)",
                                          offset + offsetof(t_Mode_C_Info, code));
        mode_c_info->addStructureVariable("code_confidence", SE_TYPE_USMALLINT, 1,
                                          "SSR mode C code confidence",
                                          offset + offsetof(t_Mode_C_Info, code_confidence));
        mode_c_info->addStructureVariable("code_garbled", SE_TYPE_BOOL, 1,
                                          "SSR mode C code garbled",
                                          offset + offsetof(t_Mode_C_Info, code_garbled));
        mode_c_info->addStructureVariable("code_invalid", SE_TYPE_BOOL, 1,
                                          "SSR mode C code not valid",
                                          offset + offsetof(t_Mode_C_Info, code_invalid));
        mode_c_info->addStructureVariable("hits", SE_TYPE_USMALLINT, 1,
                                          "Number of SSR mode C replies",
                                          offset + offsetof(t_Mode_C_Info, hits));
        mode_c_info->addPresentStructureVariable("present", SE_TYPE_BOOL, 1,
                                                 "SSR mode C information present",
                                                 offset + offsetof(t_Mode_C_Info, present));
        ...
        rdl_description->addStructureVariable("special_position_indication", SE_TYPE_UTINYINT, 1,
                                              "Special Position Indication flag",
                                              offsetof(t_Mlat, special_position_indication));
