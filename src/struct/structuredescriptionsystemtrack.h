...
{
  public:
    StructureDescriptionSystemTrack()
        : StructureDescription(DBO_SYSTEM_TRACKS, "SystemTrack", "RDL t_Strck structure", 0)
    {
        create();
    }
  ...
  protected:
    void create()
    {
        StructureDescription* rdl_system_track_description =
            new StructureDescription(DBO_SYSTEM_TRACKS, "", "rdl t_Strk structure", 0);
        ...
        StructureDescription* calc_vel = rdl_system_track_description->addStructureDescription(
        ...
        StructureDescription* calc_climb = rdl_system_track_description->addStructureDescription(
        ...
        StructureDescription* calc_pos = rdl_system_track_description->addStructureDescription(
        ...
        /* Observed by PSR */
        rdl_system_track_description->addStructureVariable("observed_by_psr", SE_TYPE_BOOL, 1,
                                                           "Observed by PSR",
                                                           offsetof(t_Strk, observed_by_psr));

        // t_Bool observed_by_ssr;
        /* Observed by SSR */
        rdl_system_track_description->addStructureVariable("observed_by_ssr", SE_TYPE_BOOL, 1,
                                                           "Observed by SSR",
                                                           offsetof(t_Strk, observed_by_ssr));

        // t_Bool track_terminated;
        /* Track terminated */
        rdl_system_track_description->addStructureVariable("track_terminated", SE_TYPE_BOOL, 1,
                                                           "Track terminated",
                                                           offsetof(t_Strk, track_terminated));

        // t_Bool track_created;
        /* Track created */
        rdl_system_track_description->addStructureVariable(
            "track_created", SE_TYPE_BOOL, 1, "Track created", offsetof(t_Strk, track_created));

        // t_Track_Number track_number;
        /* Track number */
        offset = offsetof(t_Strk, track_number);
        StructureDescription* track_num = rdl_system_track_description->addStructureDescription(
            "track_number", "Track number", offset);
        ...
        StructureDescription* time_up = rdl_system_track_description->addStructureDescription(
        ...
        StructureDescription* mode_3a_info = rdl_system_track_description->addStructureDescription(
            "mode_3a_info", "Time of last update", offset);
        ...
        StructureDescription* measured_track_mode_c_height =
            rdl_system_track_description->addStructureDescription(
        ...
        StructureDescription* frame_time = rdl_system_track_description->addStructureDescription(
            "frame_time", "Frame time", offset);
        ...
        /* Callsign present */
        // rdl_system_track_description->addStructureVariable("callsign_present", TYPE_BOOL, 1,
        // "Callsign present", offsetof(t_Strk,callsign_present));

        // t_Callsign callsign;
        /* Callsign */
        offset = offsetof(t_Strk, callsign);
        StructureDescription* callsign =
            rdl_system_track_description->addStructureDescription("callsign", "Callsign", offset);
        ...
        rdl_system_track_description->addStructureVariable(
            "special_position_indication", SE_TYPE_BOOL, 1, "Special position indication",
        ...
        StructureDescription* aircraft_address =
            rdl_system_track_description->addStructureDescription(
