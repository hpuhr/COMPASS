...
#ifndef EVALUATIONREQUIREMENPOSITIONJOINEDPOSITIONDISTANCERMS_H
#define EVALUATIONREQUIREMENPOSITIONJOINEDPOSITIONDISTANCERMS_H
...
class JoinedPositionDistanceRMS : public JoinedPositionBase
{
public:
...
protected:
    //void addToValues (std::shared_ptr<SinglePositionDistanceRMS> single_result);
...
#endif // EVALUATIONREQUIREMENPOSITIONJOINEDPOSITIONDISTANCERMS_H
