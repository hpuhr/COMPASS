...
#ifndef EVALUATIONREQUIREMENPOSITIONSINGLEPOSITIONDISTANCERMS_H
#define EVALUATIONREQUIREMENPOSITIONSINGLEPOSITIONDISTANCERMS_H
...
class SinglePositionDistanceRMS : public SinglePositionBase
{
public:
