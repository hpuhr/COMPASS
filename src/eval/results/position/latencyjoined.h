...
#ifndef EVALUATIONREQUIREMENPOSITIONJOINEDPOSITIONLATENCY_H
#define EVALUATIONREQUIREMENPOSITIONJOINEDPOSITIONLATENCY_H
...
namespace EvaluationRequirementResult
{
    ...
    class JoinedPositionLatency : public JoinedPositionBase
    {
    public:
...
#endif // EVALUATIONREQUIREMENPOSITIONJOINEDPOSITIONLATENCY_H
