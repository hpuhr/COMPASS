...
#ifndef EVALUATIONREQUIREMENPOSITIONSINGLEPOSITIONALONG_H
#define EVALUATIONREQUIREMENPOSITIONSINGLEPOSITIONALONG_H
...
class SinglePositionAlong : public SinglePositionBase
{
public:
...
#endif // EVALUATIONREQUIREMENPOSITIONSINGLEPOSITIONALONG_H
