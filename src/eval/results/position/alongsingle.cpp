...
std::unique_ptr<nlohmann::json::object_t> SinglePositionAlong::getTargetErrorsViewable (bool add_highlight)
{
...
void SinglePositionAlong::addAnnotations(nlohmann::json::object_t& viewable, bool overview, bool add_ok)
{
...
std::vector<Eigen::Vector3d> SinglePositionAlong::getGridValues(const std::string& layer) const
{
