...
{
    return std::make_shared<JoinedModeAPresent> (result_id, requirement_, sector_layer_, eval_man_);
}
...
JoinedModeAPresent::JoinedModeAPresent(const std::string& result_id, 
                                       ...
                                       const SectorLayer& sector_layer, 
                                       EvaluationManager& eval_man)
:   JoinedPresentBase("JoinedModeAPresent", result_id, requirement, sector_layer, eval_man, "#NoRefId")
{
}
