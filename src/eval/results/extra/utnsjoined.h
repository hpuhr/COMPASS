...
#ifndef JOINEDEVALUATIONREQUIREMENTEXTRAUTNSRESULT_H
#define JOINEDEVALUATIONREQUIREMENTEXTRAUTNSRESULT_H
...
#endif // JOINEDEVALUATIONREQUIREMENTEXTRAUTNSRESULT_H
