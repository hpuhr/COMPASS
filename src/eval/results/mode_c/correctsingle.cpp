...
std::unique_ptr<nlohmann::json::object_t> SingleModeCCorrect::getTargetErrorsViewable ()
{
...
void SingleModeCCorrect::addAnnotations(nlohmann::json::object_t& viewable, bool add_ok)
{
