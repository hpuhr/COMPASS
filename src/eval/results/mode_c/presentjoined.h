...
#ifndef JOINEVALUATIONREQUIREMENTMODECRESULT_H
#define JOINEVALUATIONREQUIREMENTMODECRESULT_H
...
namespace EvaluationRequirementResult
{
    ...
    class JoinedModeCPresent : public Joined
    {
    public:
        JoinedModeCPresent(const std::string& result_id, std::shared_ptr<EvaluationRequirement::Base> requirement,
    ...
    protected:
        ...
        void addToValues (std::shared_ptr<SingleModeCPresent> single_result);
...
#endif // JOINEVALUATIONREQUIREMENTMODECRESULT_H
