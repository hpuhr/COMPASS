    ...
    : QWidget(nullptr), eval_man_(eval_man), eval_settings_(eval_settings)
{
    ...
    //form_layout->addWidget(use_filter_check_, row, 0);
    ...
    //form_layout->addWidget(use_time_check_, row, 0);
    form_layout->addRow("Use Timestamp Filter", use_time_check_);

    //++row;
    //form_layout->addWidget(new QLabel("Timestamp Begin"), row, 0);
    ...
    //form_layout->addWidget(time_begin_edit_, row, 1);
    form_layout->addRow("Timestamp Begin", time_begin_edit_);

    //++row;
    //form_layout->addWidget(new QLabel("Timestamp End"), row, 0);
    ...
    //form_layout->addWidget(time_end_edit_, row, 1);
    form_layout->addRow("Timestamp End", time_end_edit_);


    //++row;
    //form_layout->addWidget(new QLabel("Exlcuded Time Windows"), row, 0);

    //form_layout->addRow(new QLabel("Excluded Time Windows"));

    time_windows_widget_ = new TimeWindowCollectionWidget(eval_settings_.load_filtered_time_windows_);
    //form_layout->addWidget(time_windows_widget_, row, 1);
    form_layout->addRow("Excluded Time Windows",time_windows_widget_);
    ...
    //form_layout->addWidget(use_reftraj_acc_check_, row, 0);
    form_layout->addRow("Use RefTraj Accuracy Filter", use_reftraj_acc_check_);


    //++row;

    //form_layout->addWidget(new QLabel("RefTraj Minimum Accuracy"), row, 0);
    ...
    //form_layout->addWidget(use_adsb_check_, row, 0);
    ...
    //form_layout->addWidget(use_v0_check_, row, 0);
    ...
    //form_layout->addWidget(use_v1_check_, row, 0);
    ...
    //form_layout->addWidget(use_v2_check_, row, 0);
    ...
    //form_layout->addWidget(use_min_sil_v1_check_, row, 0);
    ...
    //form_layout->addWidget(min_sil_v1_edit_, row, 1);
    ...
    //form_layout->addWidget(use_max_sil_v1_check_, row, 0);
    ...
    //form_layout->addWidget(max_sil_v1_edit_, row, 1);
    ...
    //form_layout->addWidget(use_min_sil_v2_check_, row, 0);
    ...
    //form_layout->addWidget(min_sil_v2_edit_, row, 1);
    ...
    //form_layout->addWidget(use_max_sil_v2_check_, row, 0);
    ...
    //form_layout->addWidget(max_sil_v2_edit_, row, 1);
