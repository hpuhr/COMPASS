...
{
    loginf << "clearLoadedDataAndResults";
...
Result EvaluationCalculator::loadingDone()
{
    ...
    if (data_loaded_)
    {
        loginf << "has ref data" << has_ref_data << " has tst data " << has_tst_data;
...
{
    loginf << "checkReferenceDataSources";
