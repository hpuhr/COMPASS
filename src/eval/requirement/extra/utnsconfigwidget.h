...
#ifndef EVALUATIONREQUIREMENTEXTRAUTNSCONFIGWIDGET_H
#define EVALUATIONREQUIREMENTEXTRAUTNSCONFIGWIDGET_H
...
#endif // EVALUATIONREQUIREMENTEXTRAUTNSCONFIGWIDGET_H
