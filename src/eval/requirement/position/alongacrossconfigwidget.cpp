...
namespace EvaluationRequirement
{
    ...
    PositionAlongAcrossConfigWidget::PositionAlongAcrossConfigWidget(PositionAlongAcrossConfig& config)
        : QWidget(), config_(config)
    {
        ...
        connect(max_ref_time_diff_edit_, &QLineEdit::textEdited,
                this, &PositionAlongAcrossConfigWidget::maxRefTimeDiffEditSlot);
        ...
        connect(max_distance_edit_, &QLineEdit::textEdited,
                this, &PositionAlongAcrossConfigWidget::maxDistanceEditSlot);
        ...
        connect(minimum_prob_edit_, &QLineEdit::textEdited,
                this, &PositionAlongAcrossConfigWidget::minimumProbEditSlot);
    ...
    void PositionAlongAcrossConfigWidget::maxRefTimeDiffEditSlot(QString value)
    {
        loginf << "PositionAlongAcrossConfigWidget: maxRefTimeDiffEditSlot: value " << value.toStdString();
        ...
        if (ok)
            ...
            loginf << "PositionAlongAcrossConfigWidget: maxRefTimeDiffEditSlot: invalid value";
    }


    void PositionAlongAcrossConfigWidget::maxDistanceEditSlot(QString value)
    {
        loginf << "PositionAlongAcrossConfigWidget: maxDistanceEditSlot: value " << value.toStdString();
        ...
        if (ok)
            ...
            loginf << "PositionAlongAcrossConfigWidget: maxDistanceEditSlot: invalid value";
    }

    void PositionAlongAcrossConfigWidget::PositionAlongAcrossConfigWidget::minimumProbEditSlot(QString value)
    {
        loginf << "PositionAlongAcrossConfigWidget: maximumProbEditSlot: value " << value.toStdString();
        ...
        if (ok)
            ...
            loginf << "PositionAlongAcrossConfigWidget: maximumProbEditSlot: invalid value";
    }
