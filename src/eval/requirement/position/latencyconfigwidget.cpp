...
namespace EvaluationRequirement
{
        ...
        : QWidget(), config_(config)
    {
        ...
        connect(max_ref_time_diff_edit_, &QLineEdit::textEdited,
                this, &PositionLatencyConfigWidget::maxRefTimeDiffEditSlot);
    ...
    void PositionLatencyConfigWidget::maxRefTimeDiffEditSlot(QString value)
    {
        loginf << "PositionLatencyConfigWidget: maxRefTimeDiffEditSlot: value " << value.toStdString();
        ...
        if (ok)
            ...
            loginf << "PositionLatencyConfigWidget: maxRefTimeDiffEditSlot: invalid value";
    }
