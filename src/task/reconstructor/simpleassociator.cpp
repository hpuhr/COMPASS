...
//            // if (ok)
//            // {
//            //     loginf << "SimpleAssociator: canGetPositionOffset: can get offset: "
...
boost::optional<bool> SimpleAssociator::checkPositionOffsetAcceptable (
    ...
    bool do_debug)
{
    return distance_m < reconstructor_.settings().max_distance_dubious_;
    ...
    bool do_debug)
{
    ...
    return std::pair<bool, double> (distance_m < reconstructor_.settings().max_distance_dubious_,
                                   distance_m - reconstructor_.settings().max_distance_dubious_);
...
SimpleAssociator::checkPositionOffsetScore (double distance_m, double sum_stddev_est, bool secondary_verified)
{
    ...
    if (distance_m > settings.max_distance_quit_)
        return tuple<DistanceClassification, double>(
            ...
            distance_m - settings.max_distance_dubious_);
