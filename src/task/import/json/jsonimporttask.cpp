...
{
    logdbg << "readJSONFileObsoleteSlot";
}

void JSONImportTask::parseJSONDoneSlot()
{
    loginf << "parseJSONDoneSlot";
...
{
    logdbg << "parseJSONObsoleteSlot";
}

void JSONImportTask::mapJSONDoneSlot()
{
    loginf << "mapJSONDoneSlot";
...
void JSONImportTask::mapJSONObsoleteSlot() { logdbg << "mapJSONObsoleteSlot"; }
