...
ListBoxViewDataSource::ListBoxViewDataSource(std::string class_id, std::string instance_id, Configurable *parent)
...
void ListBoxViewDataSource::generateSubConfigurable (std::string class_id, std::string instance_id)
{
...
void ListBoxViewDataSource::readInfoDone (Job *job)
{
    loginf << "ListBoxViewDataSource: readInfoDone";
    assert (job);
...
void ListBoxViewDataSource::readInfoObsolete (Job *job)
{
    loginf << "ListBoxViewDataSource: readInfoObsolete";
    delete job;
}
