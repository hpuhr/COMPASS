...
{
    loginf << "resizeColumnsToContents";
...
{
    loginf << "evalClearAllExcludeTimeWindowsSlot";
...
{
    loginf << "evalDisableSelectedTargets";
...
{
    loginf << "evalClearTargetsExcludeTimeWindows";
...
{
    loginf << "evalClearTargetsExcludeRequirements";
...
{
    loginf << "evalExcludeTimeWindowsTarget";
...
{
    loginf << "evalExcludeRequirementsTarget";
