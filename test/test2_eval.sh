...
$1 --open_db ~/data/test/tmp/test2.db --evaluate --evaluation_parameters '{"active_sources_ref": {"CAT062": {"30650": true}}, "active_sources_tst": {"CAT021": {"547": true }}, "current_standard": "Dubious Targets", "dbcontent_name_ref": "CAT062", "dbcontent_name_tst": "CAT021",         "report_include_target_details": true, "report_include_target_tr_details": false, "report_skip_targets_wo_issues": true, "use_grp_in_sector": {"Dubious Targets": { "MATS_DOI": { "Optional": false }, "MATS_TMA": {"Optional": false }, "doi_adsb": { "Optional": true }, "tma2": {"Optional": false }}}}' --export_eval_report ~/data/test/tmp/test2_dub_adsb_issues_eval/report.tex --no_cfg_save --quit
