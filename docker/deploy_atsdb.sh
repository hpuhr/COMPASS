...
/app/tools/linuxdeployqt-continuous-x86_64.AppImage --appimage-extract-and-run appimage/appdir/atsdb.desktop -appimage -bundle-non-qt-libs -verbose=2 -qmake=/usr/lib/x86_64-linux-gnu/qt5/bin/qmake 
