...
In the larger section \nameref{sec:ui_overview}, the steps are described to run the application, create a database or access an existing one, import and processing data. \\

How data can be loaded is described in the section \nameref{sec:load}, with the filtering mechanism described in \nameref{sec:filters}. \\
...
In the last section \nameref{sec:appendix} additional details are given. In the section \nameref{sec:appendix_utils} some information is given how data can be manually imported into COMPASS. \\ 
