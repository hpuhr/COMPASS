...
\subsection{Scatter Data Item List}

Below the config tab, there is a list of all currently displayed scatter data items, shown with their respective color, name and data count.
Individual data items can be shown or hidden by using the check boxes.
