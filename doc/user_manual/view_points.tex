...
\begin{figure}[H]
  \centering 
    \includegraphics[width=14cm]{../screenshots/view_points_export_pdf.png}
...
\begin{figure}[H]
  \centering 
    \includegraphics[width=14cm]{../screenshots/view_points_export_pdf_status.png}
...
\begin{figure}[H]
  \centering 
    \includegraphics[width=14cm]{../screenshots/view_points_export_pdf_status2.png}
