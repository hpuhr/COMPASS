...
When new Views are added, or Views require additional data, a manual re-loaded has to be performed by the user. \\
...
To add additional views, the \includegraphics[width=0.5cm,frame]{../../data/icons/crosshair_fat.png} button can be used. Views can be added either to the window in which the buttons was clicked ('Add Here') or in a new window ('Add In New Window'). \\

Single views can be removed using the \includegraphics[width=0.5cm,frame]{../../data/icons/edit.png} buttons in the tab (near the Views name). \\
