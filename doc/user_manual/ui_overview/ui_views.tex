...
\begin{figure}[H]
    \center
    \includegraphics[width=10cm]{figures/cross_sel_histogram.png}
  \caption{Selection of data in Histogram View}
\end{figure}
...
\begin{figure}[H]
    \center
    \includegraphics[width=10cm]{figures/cross_sel_geographic.png}
  \caption{Selected data highlighted in Geographic View via cross selection}
\end{figure}
