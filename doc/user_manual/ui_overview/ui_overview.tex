...
\begin{itemize}
 ...
 \end{itemize}
 \item Currently Removed: Calculate Associations from ARTAS: Find targets based on ARTAS tracks and associate target reports based on ARTAS TRI information
   %\begin{itemize}
