...
\begin{center}
 \begin{table}[H]
  \begin{tabularx}{\textwidth}{ | l | X |  }
    ...
    \nameref{sec:eval_req_pos_distance_rms} & Calculates the probability of the position error begin within or outside an RMS threshold \\ \hline
...
%TODOV7 add dubious tracks & targets
...
\item Results Detail WGS84 Zoom Factor: Zoom factor in OSGView for target report details
\end{itemize}
\ \\
...
\begin{figure}[H]
  \hspace*{-2.5cm}
    \includegraphics[width=19cm,frame]{figures/eval_results_osgview.png}
  \caption{Evaluation results: Sector errors in OSGView}
\end{figure}
...
\begin{figure}[H]
  \hspace*{-2.5cm}
    \includegraphics[width=18cm,frame]{figures/eval_results_single_osgview.png}
  \caption{Evaluation results: Target Errors in OSGView}
\end{figure}
