...
\begin{lstlisting}[basicstyle=\small\ttfamily]
{
        ...
        {
            ...
            "reference":                   // Description of the spatial reference system the image is embedded in
            {
                "srs": "epsg:3857",        // EPSG code of the spatial reference system (SRS), e.g. WGS84 Pseudo-Mercator
                "img_origin_x": 16.37208,  // X-coordinate of the upper left image corner in the given SRS, usually its easting, e.g. WGS84 longitude
                "img_origin_y": 48.20849,  // Y-coordinate of the upper left image corner in the given SRS, usually its northing, e.g. WGS84 latitude
                "img_pixel_size_x": 1,     // Width of a pixel in units of the SRS, e.g. 1m
                "img_pixel_size_y": 1,     // Height of a pixel in units of the SRS, e.g. 1m
                "is_north_up": true        // Flag indicating if the SRS is north-up, usually 'true'
            } 
        }
        ...
}
...
displayed simultaneously e.g. in HistogramView.
