...
\begin{itemize}
 ...
 \end{itemize}
 \item \nameref{sec:task_manage_db_schema}* (Schema 'SCDB' must be selected)
 \item \nameref{sec:task_calc_radar_pos}* (Only once if Radar data exists)
 \item \nameref{sec:task_postprocess}
\end{itemize}
\ \\

\includegraphics[width=0.5cm]{../../data/icons/hint.png} If this function is used, the used database schema must be switched to 'SCDB' using \nameref{sec:task_manage_db_schema}. \\
