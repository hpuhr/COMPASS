...
A given license key can then be added into the text field, either by pasting the license text or drag \& dropping the license key text file (exactly into into the text field):
