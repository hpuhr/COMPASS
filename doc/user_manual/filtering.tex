...
\subsection{Mode 3A Codes Filter}
...
\includegraphics[width=0.5cm]{../../data/icons/hint.png} Please note that in the current database schema, the ADS-B Mode 3/A code is not defined, and therefore this filter will not filter any ADS-B target reports. This will be improved in the next version.
...
\subsection{TargetAddress Filter}
