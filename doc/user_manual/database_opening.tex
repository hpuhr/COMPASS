...
Importing performance strongly depends on CPU performance (multi-threading very beneficial), but a import of 2.5 million target reports takes about 1 minute on the author's hardware. \\
