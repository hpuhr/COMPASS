...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | l | l |}
    ...
    \includegraphics[width=0.5cm]{../../data/icons/measurement_delete.png} & Deletes All Measurements & Deletes all existing measurements \\ \hline \includegraphics[width=0.5cm]{../../data/icons/select_color.png} & Edit Selection Color & Set selection color \\ \hline
