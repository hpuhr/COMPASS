...
While a number of formats are supported, the one the author could get to work in the easiest way was KML. To add such a file, add the follow part to a 'map' (as previously):
