...
\begin{itemize}
 ...
 \item The method used to determine the detection type is currently being discussed/tested by users and will be document after being accepted.
\end{itemize}
